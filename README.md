...
| --------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`graphql-json-scalar-ts`](https://www.npmjs.com/package/@thomaslnx/graphql-json-scalar-ts)                                | ![npm downloads](https://img.shields.io/npm/dm/@thomaslnx/graphql-json-scalar-ts.svg)]           | A production-ready GraphQL JSON scalar with excellent TypeScript support.                                                                                                                                                                                              |
## 🛠 **Tools**
